/**
 * Phase-1 Playwright scraper for dining. Logged-out, public data only,
...
export async function scrapeDining(_req: FetchRequest): Promise<NormalizedResult> {
  throw new NotImplemented("fetchers/dining/scraper");
}
