/**
 * Phase-1 Playwright scraper for places. Logged-out, public data only,
...
export async function scrapePlaces(_req: FetchRequest): Promise<NormalizedResult> {
  throw new NotImplemented("fetchers/places/scraper");
}
